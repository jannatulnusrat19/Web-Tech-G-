...
<head>
    ...
    <link rel="stylesheet" href="../ExternalCSS/WelcomPage.css">
...
<body>
    <div class="container">
     ...
     <div class="options">
         ...
         <br> <br>
        <a class="button" href="./Login.php"> Owner </a> <br> <br> <br>
        <a class="button" href="./Login.php"> Tenant </a> <br> <br> <br>
        <a class="button" href="./Login.php"> Buyer.. </a> <br> <br> <br>
